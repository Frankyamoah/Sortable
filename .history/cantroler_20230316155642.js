...
import  {renderHerosView, resultsPerPageHandlerView, PaginationBtnsHandlers}     from './view.js'
...
const controlLoadData = async ()=> {
  try{
   ...
   console.log(state.heros.find(el => el.name.inculdes('wolfsbane')))
   resultsPerPageHandlerView(state.heros, renderHerosView )

...
if (e.target.classList.contains('sortth')){
 ...
 const derection = table.dataset.darection
  ...
  switch (1 < 2){
    case  quary === "name":
       if(+derection === 1){
            renderHeros([...data].sort((a, b)=> a.biography.fullName.toUpperCase().localeCompare( b.biography.fullName.toUpperCase())), 1, pagenum)
      ...
      case  quary === "fullName":
      if(+derection === 1){
       const sorted  = [...data].sort((a, b) => a.biography.fullName.toUpperCase().localeCompare( b.biography.fullName.toUpperCase()))
    ...
    renderHeros([...data].sort((a, b) => (a.biography.fullName.toUpperCase()>  b.biography.fullName.toUpperCase() ? -1 : 1)), 1 ,pagenum)
    table.dataset.darection = 1
   }
  break;

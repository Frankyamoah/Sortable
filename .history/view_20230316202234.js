 ...
 const derection = table.dataset.darection
  ...
  switch (1 < 2){
    case  quary === "name":
      ...
      if(+derection === 1){
        console.log(quary)
        renderHeros([...data].sort((a, b) => a.biography.fullName.localeCompare( b.biography.fullName)), 1, pagenum)
        console.log([...data].sort((a, b) => a.biography.fullName.localeCompare( b.biography.fullName)))
        // console.log([...data].sort((a, b)=> a.biography.fullName - b.biography.fullName))
        table.dataset.darection = -1
        return
   } else{

...
import  {renderHerosView, resultsPerPageHandlerView, PaginationBtnsHandlers, sortHandler}     from './view.js'
...
const controlLoadData = async ()=> {
  ...
  //  JSON.parse(JSON.stringify(arr))
   resultsPerPageHandlerView(JSON.parse(JSON.stringify(arr)).sort((a, b)=> a.name.toLowerCase().localeCompare( b.name.toLowerCase())), renderHerosView )
